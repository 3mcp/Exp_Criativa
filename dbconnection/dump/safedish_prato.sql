...
CREATE TABLE `prato` (
  ...
  `NomePrato` varchar(200) DEFAULT NULL,
  `DescricaoPrato` varchar(400) DEFAULT NULL,
  `FotoPrato` mediumblob,
  `PrecoPrato` varchar(10) DEFAULT NULL,
  `fk_Restaurante_IdRestaurante` int DEFAULT NULL,
  PRIMARY KEY (`IdPrato`),
  KEY `FK_Prato_2` (`fk_Restaurante_IdRestaurante`),
  CONSTRAINT `FK_Prato_2` FOREIGN KEY (`fk_Restaurante_IdRestaurante`) REFERENCES `restaurante` (`IdRestaurante`) ON DELETE RESTRICT
