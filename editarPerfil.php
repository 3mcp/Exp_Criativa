                ...
                if (isset($_SESSION["ID"])) {
                    ...
                    ?>
                        ...
                        <form action="databaseRestaurante/restauranteEditar.php" method="post" enctype="multipart/form-data" onsubmit="return validaterestaurantForm()">
                            ...
                            <div class='inputWrapper'>
                                <p>Segunda Feira</p>
                                <input type="text" name="segundaAbre" placeholder="Abre" value="<?php echo $horario[0] ?>" oninput="formatTime(this)">
                                <input type="text" name="segundaFecha" placeholder="Fecha" value="<?php echo $horario[1] ?>" oninput="formatTime(this)">
                            </div>
                            <div class='inputWrapper'>
                                <p>Terça Feira</p>
                                <input type="text" name="tercaAbre" placeholder="Abre" value="<?php echo $horario[2] ?>" oninput="formatTime(this)">
                                <input type="text" name="tercaFecha" placeholder="Fecha" value="<?php echo $horario[3] ?>" oninput="formatTime(this)">
                            </div>
                            <div class='inputWrapper'>
                                <p>Quarta Feira</p>
                                <input type="text" name="quartaAbre" placeholder="Abre" value="<?php echo $horario[4] ?>" oninput="formatTime(this)">
                                <input type="text" name="quartaFecha" placeholder="Fecha" value="<?php echo $horario[5] ?>" oninput="formatTime(this)">
                            </div>
                            <div class='inputWrapper'>
                                <p>Quinta Feira</p>
                                <input type="text" name="quintaAbre" placeholder="Abre" value="<?php echo $horario[6] ?>" oninput="formatTime(this)">
                                <input type="text" name="quintaFecha" placeholder="Fecha" value="<?php echo $horario[7] ?>" oninput="formatTime(this)">
                            </div>
                            <div class='inputWrapper'>
                                <p>Sexta Feira</p>
                                <input type="text" name="sextaAbre" placeholder="Abre" value="<?php echo $horario[8] ?>" oninput="formatTime(this)">
                                <input type="text" name="sextaFecha" placeholder="Fecha" value="<?php echo $horario[9] ?>" oninput="formatTime(this)">
                            </div>
                            <div class='inputWrapper'>
                                <p>Sábado</p>
                                <input type="text" name="sabadoAbre" placeholder="Abre" value="<?php echo $horario[10] ?>" oninput="formatTime(this)">
                                <input type="text" name="sabadoFecha" placeholder="Fecha" value="<?php echo $horario[11] ?>" oninput="formatTime(this)">
                            </div>
                            <div class='inputWrapper'>
                                <p>Domingo</p>
                                <input type="text" name="domingoAbre" placeholder="Abre" value="<?php echo $horario[12] ?>" oninput="formatTime(this)">
                                <input type="text" name="domingoFecha" placeholder="Fecha" value="<?php echo $horario[13] ?>" oninput="formatTime(this)">
                            </div>
                            <div class="formButtons">
